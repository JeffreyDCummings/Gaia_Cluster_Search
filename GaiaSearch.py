...
#degrees typically times out and the DR2 website must be used directly.
radius=0.3

#Cut all targets from output that have a parallax (mas) below parallax_cut or a ratio below parallax_error_ratio
parallax_cut=1
...
#The cluster name that will be search for position in SIMBAD
Objectname="NGC 2547"
...
#If you want to define RA and DEC directly, put them here (degrees)
	#RAset=116
	#DECset=-38
...
#Search Gaia database and return to dataframe of Filename the columns of interest for a circular search of defined radius and parallax cuts around ObjectName.
